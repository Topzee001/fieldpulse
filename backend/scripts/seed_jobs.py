...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for i in range(120):
            ...
            scheduled_start = scheduled_date.replace(hour=hour, minute=minute)
        ...
        self.stdout.write(self.style.SUCCESS(f"✅ Created {jobs_created} jobs for technician: {tech.email}"))
